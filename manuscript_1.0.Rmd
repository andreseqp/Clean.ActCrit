...
a Metropolis sampler to estimate the posterior distribution of the model parameters. We used the data from @triki_Biological_2019 to fit the parameters of the  model analyzed in @quinones_Reinforcement_2019. The data consist a of the number of times that a set of cleaners chose to
