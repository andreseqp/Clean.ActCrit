...
interact with visitors [@triki_Zeni_inpress]. Such a preference may be
...
correlated with parasite load(Grutter xxxx). However, early laboratory
...
operant conditioning (Thorndike 1917), this explanation can be
...
[@sutton_Reinforcement_2018; \@rescola_Theory_1972]; and it is carried
...
effects of their choices. The model analysis by
...
supported by @triki_Biological_2019 data. However, a combination of
...
The emptier the cleaning stations are, the more benefitial it is to
prioritize a client that will not stay. However, the frequency of empty
spots in the cleaning station does not only depend on cleaner relative
abundances but also on the frequency with which clients visit the
...
of the variable. We fit the value of the scaling constant as part of the
...
cleaners better than others at adjusting their behaviour.
...
the ones reported in @triki_Brain_2020, is configurational learning or
...
exposed to demonstrations before acquisition. Importantly,
