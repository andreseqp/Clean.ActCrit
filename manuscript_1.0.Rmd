...
negative reward, the distribution of $\gamma$ shifts to higher values. Under the new model, the estimates of $\gamma$ do not include zero, the distribution is centered arounf $0.5$.
...
in the market task. We compared future reward with the use of client behaviour as 
...
leave, it's likely that the cleaner will have access to another client, and there won't be much difference in future reward between choosing a visitor and a resident. Thus,
estimation of future reward will not develop a preference for the visitor in this 
conditions, because it matches the state of the market. On the other hand, the effect of negative reward is unaffected by this market situation. In a full station, cleaners will get more often the heterotypic (resident-visitor) option and will develop a preference for the visitor faster. Estimation of future reward is then the cognitive mechanism 
that allows cleaner to adaptively respond to the ecological conditions of the biological market.

<!-- ### Correlation of visitor leaving and cleaner density  -->



<!-- ### Cognition as an explanation -->

<!-- bash on social competence -->

<!-- Cognitive processes gain support as an explanation for inter and intra-specific  -->
<!-- variation in the market task. Even though the model considered here does not  -->
<!-- explicitly model perception, associative processes must include the perception  -->
<!-- of different stimuli which allow cleaners to discriminate -->
<!-- residents and visitors. Thus, the fact that recent experimental work shows -->
<!-- an effect of the perceptual conditions in the experiments on the performance of  -->
<!-- the subjects, supports the idea that learning is involved in the decision  -->
<!-- making process of the market task. Furthermore, and notably, certain features  -->
<!-- of brain anatomy correlate with performance in the market task and with the  -->
<!-- abundance of cleaners in the location where the fish were collected [@triki_Brain_2020].  -->
<!-- All this, supports the idea that learning processes are behind the behavioural  -->
<!-- adjustment that cleaners show to environmental conditions.  -->
